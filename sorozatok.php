...
$comments = [
    [
        ...
        "rating" => 11,
        "text" => "Nagyon tetszett a Totál Szívás, jogos a 11 csillag!!!négy!"
    ],

    [
        "username" => "pistike",
        "date" => new \DateTime("2021-03-25"),
        "rating" => 6,
        "text" => "WandaVízió nagyon jó sorozat, viszont a vége nem tetszett nekem :("
    ],
    ...
    <section>
        ...
        <?php foreach ($comments as $comment) { ?>
            <div id="komment">
                ...
                <div class="datum"><?php echo $comment["date"]->format("Y.m.d"); ?></div>
